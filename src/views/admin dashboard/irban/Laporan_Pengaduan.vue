  ...
  <div class="body">
    <div class="laporan-aktif">
      <div class="laporan-aktif-header">
        ...
        <p>Menampilkan daftar laporan pengaduan yang ditugaskan kepada anda</p>
        ...
        <div class="laporan-aktif-body">
          ...
          <p v-if="laporan.length == 0" style="color: grey; margin: 2rem">
            belum ada laporan perceraian yang ditugaskan kepada anda
          </p>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async ambil_pengaduan() {
      document.title = `${this.$store.state.app_name} | Pengaduan`;
      await axios
        .get(this.$store.state.common.baseUrl + "/api/laporan/show_pengaduan", {
          headers: {
        ...
        .then((res) => {
          ...
          res.data.data.map((data) => {
            if (data.owner != undefined)
              if (data.owner._id == this.currentLogin._id) {
                this.laporan.unshift(data);
              }
          });
        })
        .catch(() => {
