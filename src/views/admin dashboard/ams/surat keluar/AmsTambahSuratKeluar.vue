  ...
  <div class="body">
    <div class="tambah-surat">
      <div class="tambah-surat-header">
        ...
        <p>Lengkapi data dibawah ini untuk menambahkan surat baru</p>
      ...
      <div class="tambah-surat-isian">
        <div class="tambah-surat-isian-field">
          ...
          <div class="tambah-surat-isian-field-form upload-file">
            <label for="file">
              <i
                class="pi pi-upload"
  ...
  methods: {
    ...
    async kirim_data() {
      ...
      if (no_agenda.length == 0) {
        ...
        formData.append("klasifikasi", "surat keluar");
        ...
        formData.append(
          "owner",
          JSON.stringify(this.$store.state.currentLogin)
        );
        await axios
          .post(
            this.$store.state.common.baseUrl + "/api/surat/store",
            formData,
            {
              headers: {
          ...
          .then(() => {
            this.$router.push({ name: "ams_surat_keluar" });
            let alert = this.$store.state.alert;
            alert.show = true;
            alert.type = "success";
            alert.message = "Berhasil tambah surat";
            window.setTimeout(() => {
              alert.show = false;
            }, 3000);
          })
          .catch(() => {
            ...
            alert.show = true;
            alert.type = "error";
            alert.message = "Maaf, Gagal tambah surat";
            window.setTimeout(() => {
              alert.show = false;
            }, 3000);
          });
